...
Once the runtime starts, you can access the project at [http://localhost:8080/jakartaee-app-web](http://localhost:8080/jakartaee-app-web).
...
```
./mvnw clean package
docker build -t jakartaee-app-web:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 jakartaee-app-web:v1
```
